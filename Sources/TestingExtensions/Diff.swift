...
// TODO: Code also present on LoggerMiddleware. Find a better home for both to avoid duplication.
public func diff(old: String, new: String) -> String? {
    ...
    ).lazy.flatMap { [$0.patchMark] + $0.lines }.joined(separator: "\n")
}

public func diff(_ fst: [String], _ snd: [String]) -> [Difference<String>] {
